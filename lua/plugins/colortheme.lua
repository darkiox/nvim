return {
	...
	config = function()
		...
		-- Function to make the diagnostics background transparent
		...
		-- Function to toggle background transparency globally (editor + file tree)
		local toggle_transparency = function()
			config.transparent = not config.transparent
			onedark.setup(config)
			onedark.load()

			-- Apply transparency to diagnostic virtual texts
			set_diagnostics_bg_transparency()
		end

		-- Set keybinding to toggle background transparency
